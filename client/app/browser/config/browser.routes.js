    ...
    .config(function ($stateProvider) {
      $stateProvider
        .state('app.browser', {
          abstract: true,
          url: '/browser',
          templateUrl: 'app/browser/views/main.html'
        })
        .state('app.browser.models', {
          url: '',
          templateUrl: 'app/browser/views/models.html',
          controllerAs: 'ctrl',
          controller: [
            'models',
            function (models) {
        ...
        .state('app.browser.models.info', {
          url: '/:modelName/info',
          templateUrl: 'app/browser/views/models.info.html',
          controllerAs: 'info',
          controller: [
            'model',
            function (model) {
        ...
        .state('app.browser.models.items', {
          url: '/:modelName',
          templateUrl: 'app/browser/views/models.items.html',
          controllerAs: 'items',
          controller: [
            'model',
            'items',
        ...
        .state('app.browser.models.items.view', {
          url: '/:modelId/view',
          templateUrl: 'app/browser/views/models.items.view.html',
          controllerAs: 'view',
          controller: [
            'item',
            function (item) {
        ...
        .state('app.browser.models.items.edit', {
          url: '/:modelId/edit',
          templateUrl: 'app/browser/views/models.items.edit.html',
          controllerAs: 'edit',
          controller: [
            '$state',
            'MetaService',
        ...
        .state('app.browser.models.items.add', {
          url: '/add',
          templateUrl: 'app/browser/views/models.items.add.html',
          controllerAs: 'add',
          controller: [
            '$state',
            'MetaService',
