    ...
    .config(function ($stateProvider) {
      $stateProvider
        .state('app.events', {
          abstract: true,
          url: '/events',
          templateUrl: 'app/events/views/main.html'
        })
        .state('app.events.list', {
          url: '',
          templateUrl: 'app/events/views/list.html',
          controllerAs: 'ctrl',
        ...
        .state('app.events.add', {
          url: '/add',
          templateUrl: 'app/events/views/form.html',
          controllerAs: 'ctrl',
        ...
        .state('app.events.view', {
          url: '/:id',
          templateUrl: 'app/events/views/view.html',
          controllerAs: 'ctrl',
