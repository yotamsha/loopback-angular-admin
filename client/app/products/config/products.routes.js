    ...
    .config(function ($stateProvider) {
      $stateProvider
        .state('app.products', {
          abstract: true,
          url: '/products',
          templateUrl: 'app/products/views/main.html'
        })
        .state('app.products.list', {
          url: '',
          templateUrl: 'app/products/views/list.html',
          controllerAs: 'ctrl',
        ...
        .state('app.products.add', {
          url: '/add/:categoryId',
          templateUrl: 'app/products/views/form.html',
          controllerAs: 'ctrl',
        ...
        .state('app.products.addcategory', {
          url: '/addcategory',
          templateUrl: 'app/products/views/categoryform.html',
          controllerAs: 'ctrl',
        ...
        .state('app.products.view', {
          url: '/:productId',
          templateUrl: 'app/products/views/view.html',
          controllerAs: 'ctrl',
